...
//https://webprogrammingforappsandservices.sdds.ca/Introduction-JWT/json-web-tokens-jwt
let strategy = new JwtStrategy(jwtOptions, function (jwt_payload, next) {
    console.log('payload received', jwt_payload);
  
    if (jwt_payload) {
      // The following will ensure that all routes using passport.authenticate
      // have req.user._id, req.user.userName, req.user.fullName & req.user.role values
